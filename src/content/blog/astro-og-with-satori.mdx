...
OpenGraph (OG) images are a great way to increase click-through rates and make link previews more
appealing - on average, **posts with Open Graph images get 2.3x more clicks than those without.**

In this post, I'll be showing you how to generate OpenGraph images for your Astro site using **Satori,**
an easy-to-use library that lets you generate images using React or Preact, making it super easy to
reap the benefits of OG images.
...
font here, but feel free to pick your own. **Note that the relative paths are relative
